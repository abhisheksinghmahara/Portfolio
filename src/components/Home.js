  ...
  return (
    <div className="flex flex-wrap flex- flex-grow md-flex-column">
      <div className="flex-1 ">
        <h1
          style={{ "font-family": "Playwrite CU, cursive" }}
          className="pt-40 text-gray-500 text-5xl"
        >
          Welcome
        </h1>
        <hr class="w-40 h-px mx-auto my-4 bg-gray-700 border-0 rounded md:my-1 dark:bg-gray-700"></hr>
        <h1
          className="pt-5 break-words text-xl"
          style={{ "font-family": "Baskervville SC, system-ui" }}
        >
          Hello! It's me, <br />
          <span
            className="pl-20 text-2xl"
            style={{ "font-family": "Bebas Neue, system-ui", color: "blue" }}
          >
            Abhishek Mahara,
          </span>
          <br />
      ...
      <div className="flex-1 bg-blue-100">
        <p
          ...
          style={{ "font-family": "Rajdhani, system-ui" }}
        >
